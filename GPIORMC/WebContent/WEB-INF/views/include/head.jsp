...
<!-- 富文本编辑器 -->
<link href="${ctxStatic}/wangEditor/2.1.13/css/wangEditor.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/wangEditor/2.1.13/js/wangEditor.min.js" type="text/javascript"></script>
