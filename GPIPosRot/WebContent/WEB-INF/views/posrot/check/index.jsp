...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/posrot/jobrotation/checklist" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
		...
		var setting = {
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					//alert("id:" + id);
					//alert("pId:" + pId);
					$('#officeContent').attr("src", "${ctx}/posrot/jobrotation/checklist?orgNo=" + id);
				}
			}
		};
