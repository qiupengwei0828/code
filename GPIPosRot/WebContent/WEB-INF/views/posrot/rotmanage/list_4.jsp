...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/posrot/rotManage/list4">待接收(${status4})</a></li>
	...
	<form:form id="pageForm" modelAttribute="rotation" action="${ctx}/posrot/rotManage/list4" method="post" class="breadcrumb form-search" style="display:none;">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}" />
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}" />
	</form:form>


	<form:form id="sForm" modelAttribute="rotation" action="${ctx}/posrot/rotManage/list4" method="post" class="breadcrumb form-search">
		<label>计划编号：</label>
