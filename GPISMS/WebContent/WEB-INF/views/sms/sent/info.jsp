...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sms/sent/list">已发送短信列表</a></li>
		<li class="active"><a>短信详情</a></li>
	</ul>
	<br />

	<form:form id="inputForm" modelAttribute="sent" action="" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sentDate" htmlEscape="false" maxlength="50" />
			</div>
		</div>
