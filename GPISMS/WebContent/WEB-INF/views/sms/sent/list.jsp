...
<body>
	<form:form id="searchForm" modelAttribute="sent" action="" method="post" class="breadcrumb form-search">
	...
	<script type="text/javascript">
		...
		function pageInit() {
			...
			function formatEdits(cellValue, options, rowObject) {
				return "<a href='" + "${ctx}/sms/sent/info?id=" + cellValue + "'>" + "详情" + "</a>";
			}
