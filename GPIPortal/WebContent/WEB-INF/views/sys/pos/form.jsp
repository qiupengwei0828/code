...
<body>
	...
	<form:form id="inputForm" modelAttribute="pos" action="" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="posCode" htmlEscape="false" maxlength="50" id="posCode" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="posName" htmlEscape="false" maxlength="50" id="posName" />
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline"><font color="red" id="limitDateError">*</font></span>
			</div>
		</div>
