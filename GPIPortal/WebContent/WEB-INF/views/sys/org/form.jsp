...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/org/list?orgNo=${org.orgNo}&pOrgNo=${org.pOrgNo}">机构列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="org" action="" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<%-- <sys:treeselect id="pOrgNo" name="pOrgNo" value="${org.pOrgNo}" labelName="orgName" labelValue="${org.pOrgNo}" title="机构代码" url="/sys/org/treeData" cssClass="required" /> --%>
				<sys:treeselect id="pOrgNo" name="pOrgNo" value="${org.pOrgNo}" labelName="" labelValue="${org.orgName}" title="机构代码" url="/sys/org/treeData" cssClass="required" />
				<span class="help-inline"><font color="red" id="appCodeError">*</font></span>
			</div>
		</div>
