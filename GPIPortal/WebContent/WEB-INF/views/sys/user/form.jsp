...
<script type="text/javascript">
	$(document).ready(function() {
		/* 判断当前userId是否有值
		 * 如果没有则是添加页面，去除userId的只读属性
		 * 设置form的action为(${ctx}/sys/user/addUser)添加URL
		 * 如果有
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/user/form?id=${user.userId}">用户${not empty
	...
	<form:form id="inputForm" modelAttribute="user" action="" method="post" class="form-horizontal">
		...
		<div class="row">
			...
			<div class="span3">
				<input id="beginWorkDate" name="beginWorkDate" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate" style="width:150px" value="<fmt:formatDate value="${log.beginDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="row">
			...
			<div class="span3">
				<input id="posDate" name="posDate" type="text" readonly="readonly" maxlength="50" class="input-mini Wdate" style="width:150px" value="<fmt:formatDate value="${log.beginDate}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			</div>
			<div class="span2">
				<label>办公电话</label>
