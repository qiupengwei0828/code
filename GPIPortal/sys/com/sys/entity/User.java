...
public class User extends BaseEntity {
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", pwd=" + pwd + ", salt=" + salt + ", hrNo=" + hrNo + ", orgNo=" + orgNo + ", depCode=" + depCode + ", sex=" + sex + ", certTyp="
				+ certTyp + ", certNo=" + certNo + ", nativePlace=" + nativePlace + ", nation=" + nation + ", userClass=" + userClass + ", birthday=" + birthday + ", beginWorkDate=" + beginWorkDate
				+ ", politicalStatus=" + politicalStatus + ", stLevel=" + stLevel + ", post=" + post + ", rank=" + rank + ", posTitle=" + posTitle + ", pos=" + pos + ", posDate=" + posDate + ", tel="
				+ tel + ", mobile=" + mobile + ", email=" + email + ", mobile2=" + mobile2 + ", status=" + status + ", crtUser=" + crtUser + ", crtTime=" + crtTime + ", roleCode=" + roleCode
				+ ", orgName=" + orgName + "]";
	}
