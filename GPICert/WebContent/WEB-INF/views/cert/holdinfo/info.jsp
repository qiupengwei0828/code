...
<body>
	...
	<table class="table table-bordered table-hover">
		<c:forEach items="${list}" var="certJobCfg" begin="0" end="0">
			<tr>
				...
				<td><h4>当前岗位：${fns:getDicLabel(certJobCfg.pos,"DIC_USER_POSITION", "")}</h4></td>
	...
	<c:if test="${hold1 == 1}">
		...
		<table id="contentTable" class="table table-hover table-bordered table-condensed table-hover">
			<tr>
				<!-- <th>持有要求</th> -->
			...
			<c:forEach items="${list}" var="certJobCfg" varStatus="status">
				<c:if test="${certJobCfg.holdReq == '1'}">
					...
					<td>${fns:getDicLabel(certJobCfg.industry,"DIC_CERT_INDUSTRY", "")}</td>
