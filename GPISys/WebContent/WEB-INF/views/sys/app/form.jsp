...
<body>
	...
	<form:form id="inputForm" modelAttribute="app" action="" method="post" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="appCode" htmlEscape="false" maxlength="50" class="required" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" placeholder="输入数字、字母或数字字母组合" id="appCode" />
