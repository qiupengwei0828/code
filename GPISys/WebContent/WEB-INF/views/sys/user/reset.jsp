	...
	$(document).ready(function() {
		...
		$("#trueBtn").click(function() {
			$.ajax({
				type : "POST",
				dataType : 'json',
				url : '${ctx}/sys/user/resetAllPWDIsNull',
...
<body>
	<div class="body_title">
		...
		<div class="form-actions">
			<img alt="" src="${ctxStatic}/images/alert.png" style="width: 32px;height: 32px;">&nbsp;&nbsp;&nbsp;&nbsp;<input id="btnSubmit" class="btn btn-danger" type="button" value="重置密码"
