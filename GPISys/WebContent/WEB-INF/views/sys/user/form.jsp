...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSubmit").click(function() {
			...
			if (userId != "" && userName != "" && hrNo != "" && orgNo != "" && certNo != "" && pos != "" && status != "") {
				changeBtnSubmit();
			} else {
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/user/form?id=${user.userId}">员工${not empty user.userId?'修改':'添加'}</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="user" action="" method="post" class="form-horizontal">
		...
		<div class="row">
			...
			<div class="span3">
				<form:input path="userId" htmlEscape="false" maxlength="50" style="width:150px" id="userId" />
		...
		<div class="row">
			...
			<div class="span3">
				...
				<span class="help-inline"><font color="red" id="posError">*</font></span>
			</div>
		...
		<div class="row">
			...
			<div class="span3">
				<input id="posDate" name="posDate" type="text" readonly="readonly" maxlength="50" class="input-mini Wdate" style="width:150px"
...
--%>
		...
		<div class="row">
			...
			<div class="span3">
				<input id="beginWorkDate" name="beginWorkDate" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate" style="width:150px"
					value="<fmt:formatDate value="${log.beginDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			</div> --%>
