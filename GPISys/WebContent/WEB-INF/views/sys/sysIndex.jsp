...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#menu a.menu").click(function() {
			...
			// 显示二级菜单,  menuId只有一个是固定的，一级ID menu-0
			var menuId = "#menu-0" //+ $(this).attr("data-id");
			if ($(menuId).length > 0) {
				//$("#left .accordion").hide();    
				//$(menuId).show();
				// 初始化点击第一个二级菜单
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand">
					<span id="productName">中国邮政储蓄银行综合业务管理平台</span>
				</div>
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" title="主题切换"><i class="icon-th-large"></i></a>
					...
					<li id="userInfo" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${fns:getUser().name}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
						<ul class="dropdown-menu">
		...
		<div class="container-fluid">
			...
			<div id="footer" class="row-fluid">Copyright &copy; 2015-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By JK ${fns:getConfig('version')}</div>
		</div>
	</div>
	<script type="text/javascript">
