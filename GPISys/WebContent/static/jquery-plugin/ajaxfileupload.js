jQuery.extend({
	...
	/*
	 * handleError: function( s, xml, status, e ) { // If a local callback was
	 * specified, fire it if ( s.error ) s.error( xml, status, e ); // Fire the
	 * global callback if ( s.global ) jQuery.event.trigger( "ajaxError", [xml,
	 * s, e] ); }
	 */
