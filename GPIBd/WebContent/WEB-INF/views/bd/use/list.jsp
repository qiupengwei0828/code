...
<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/bd/use/list">使用列表</a></li>
		<li><a href="${ctx}/bd/use/form">用量登记</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bdUseDetail" action="${ctx}/bd/use/list?orgNo=${bdUseDetail.orgNo}" method="post" class="breadcrumb form-search" style="display:none;">
