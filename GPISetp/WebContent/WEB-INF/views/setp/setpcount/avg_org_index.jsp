...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/setp/setpCount/avg_org_list?orgNo=${orgNo}" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
		...
		var setting = {
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					$('#officeContent').attr("src", "${ctx}/setp/setpCount/avg_org_list?orgNo="+id);
				}
			}
		};
