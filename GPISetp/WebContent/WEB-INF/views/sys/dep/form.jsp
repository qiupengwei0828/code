...
<body>
	...
	<form:form id="inputForm" modelAttribute="dep" action="" method="post" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="depCode" htmlEscape="false" maxlength="50" class="required" placeholder="输入数字、字母或数字字母组合" id="depCode" onblur="depCodeajax()" onclick="clear_depCodeError_msg()" />
