...
%>
	<form action="" method="POST">
		&nbsp;name: <input type=text size=20 name="dataName"> <br> value: <input type=text size=20 name="dataValue"> <br> <input type=submit>
	</form>

	<%="最大内存: " + (Runtime.getRuntime().maxMemory() / 1024 / 1024) + "m, 已分配内存: " + (Runtime.getRuntime().totalMemory() / 1024 / 1024) + "m, 已分配内存中的剩余空间: "
