...
<body>
 <form:form id="searchForm" modelAttribute="courtQueryInfo" action="${ctx}/procuratorate/check/uncheckList" method="post" class="breadcrumb form-search" style="display:none;">
	...
	<form:form id="searchForm" modelAttribute="courtQueryInfo" action="${ctx}/court/check/uncheckList" method="post" class="breadcrumb form-search">
	    <label>承办法官：</label>
		<form:input path="judgeName" htmlEscape="false" maxlength="50" style="width:120px" id="judgeName" />
	    <label>被查询人姓名：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="courtQueryInfo">
			<tr>
			    ...
			    <td><a
					href="${ctx}/court/check/check?queryId=${courtQueryInfo.queryId}">审核</a>
					<a
					href="${ctx}/court/check/checked?queryId=${courtQueryInfo.queryId}">查看详情</a>
					</td>		   
			</tr>
		</c:forEach>
	</table>
