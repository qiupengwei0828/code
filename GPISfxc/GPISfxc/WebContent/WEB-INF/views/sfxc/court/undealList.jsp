	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="courtQueryInfo">
			<tr>
			    ...
			    <td><a
					href="${ctx}/court/deal/feedback?queryId=${courtQueryInfo.queryId}">信息填写</a>
			    <a
					href="${ctx}/court/deal/feed?bdhm=${courtQueryInfo.queryId}" onclick="return confirmx('确认提交反馈信息吗？', this.href)" >反馈信息</a></td>		   
			</tr>
		</c:forEach>
	</table>
