...
<body>
 <form:form id="searchForm" modelAttribute="proQueryInfo" action="${ctx}/procuratorate/check/uncheckList" method="post" class="breadcrumb form-search" style="display:none;">
	...
	<form:form id="searchForm" modelAttribute="proQueryInfo" action="${ctx}/procuratorate/check/uncheckList" method="post" class="breadcrumb form-search">
	    <label>承办检察官：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="proQueryInfo">
			<tr>
			    ...
			    <td><a
					href="${ctx}/procuratorate/check/check?queryId=${proQueryInfo.queryId}">审核</a>
					<a
					href="${ctx}/procuratorate/check/checked?queryId=${proQueryInfo.queryId}">查看详情</a>
					</td>		   
			</tr>
		</c:forEach>
	</table>
