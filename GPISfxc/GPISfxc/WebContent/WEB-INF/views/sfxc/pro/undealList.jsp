...
<body>
 <form:form id="searchForm" modelAttribute="proQueryInfo" action="${ctx}/procuratorate/deal/undealList" method="post" class="breadcrumb form-search" style="display:none;">
	...
	<form:form id="searchForm" modelAttribute="proQueryInfo" action="${ctx}/procuratorate/deal/undealList" method="post" class="breadcrumb form-search">
	   <label>承办检察官：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="proQueryInfo">
			<tr>
			    ...
			    <td><a
					href="${ctx}/procuratorate/deal/feedback?queryId=${proQueryInfo.queryId}" >信息填写</a>
					<a
					href="${ctx}/procuratorate/deal/feed?bdhm=${proQueryInfo.queryId} " onclick="return confirmx('确认提交反馈信息吗？', this.href)" >信息反馈</a></td>		   
			</tr>
		</c:forEach>
	</table>
