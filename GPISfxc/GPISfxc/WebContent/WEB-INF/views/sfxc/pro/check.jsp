...
<script type="text/javascript">
        ...
        function onclicksub(){
		  if(document.getElementById("bc").value!=""&&document.getElementById("bc").value!=null){
		    window.location.href=encodeURI(encodeURI("${ctx}/procuratorate/check/back?bdhm="+$("#queryId").val()+"&remark="+document.getElementById("bc").value));	
		  }else{
		    showTips( '请填写退回原因！', 1000, 200,5 );
		  }  		 
		  }
