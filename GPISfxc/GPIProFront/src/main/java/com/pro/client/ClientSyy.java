...
public class ClientSyy {
	...
	private String getQueryInfo="getXzcxList";//调用该接口返回甘肃省人民检察院请求的账户查询信息。
    private String feedQueryInfo="shfeedXzcxInfo";//调用该接口将账户查询结果信息反馈请求单位。
     ...
     */
	  ...
	  {      
		   ...
		   if (!isRuning) {
		   isRuning=true;
		   FileDeal.feedQueryInfo(feedQueryInfo);//反馈
		   isRuning=false;
		   }
