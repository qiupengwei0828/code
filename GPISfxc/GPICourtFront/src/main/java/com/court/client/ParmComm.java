...
public class ParmComm {
     ...
     public static String getCertInfo()
     {
    	 ...
    	 String userStr=Base64Util.encodeGbk(PropertiesUtil.readValue("sfxc.properties","court.data.sys.user"));
	     String pwdStr=Base64Util.encodeGbk(PropertiesUtil.readValue("sfxc.properties","court.data.sys.pwd"));	    	 
