...
public class TimeHelper {
	...
	/**
	 * 得到前一天的时间，精确到毫秒,共19位 返回格式:yyyy-MM-dd HH:mm:ss
	 * 
	 * @return String
	 */
	@SuppressWarnings("static-access")
...
//		int month = calendar.get(Calendar.MONTH) + 1; // 月份
	 ...
	 * @throws ParseException 
	 */
	public static long getTimeMillis(String dateTime, String form) throws Exception{
		 Calendar c = Calendar.getInstance();
		   
		 c.setTime(new SimpleDateFormat(form).parse(dateTime));
	...
	public static void main(String[] args) {
		 //long d = 0;
		try {
			System.out.println(TimeHelper.getTimeMillis("2013-07-07 08:00:01","yyyy-MM-dd HH:mm:ss"));
		} catch (Exception e) {
